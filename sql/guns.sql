...
INSERT INTO `sys_menu` VALUES (114, 'pages.modular.system.group', 'system', '[0],[system],', '角色管理', NULL, '/pages.modular.system.group', 2, 2, 'Y', NULL, 'ENABLE', NULL, '0', NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (115, 'role_add', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '添加角色', NULL, '/pages.modular.system.group/add', 1, 3, 'N', NULL, 'ENABLE', NULL, '0', NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (116, 'role_edit', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '修改角色', NULL, '/pages.modular.system.group/edit', 2, 3, 'N', NULL, 'ENABLE', NULL, '0', NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (117, 'role_remove', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '删除角色', NULL, '/pages.modular.system.group/remove', 3, 3, 'N', NULL, 'ENABLE', NULL, '0', NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (118, 'role_setAuthority', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '配置权限', NULL, '/pages.modular.system.group/setAuthority', 4, 3, 'N', NULL, 'ENABLE', NULL, '0', NULL, NULL, NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (162, 'to_role_edit', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '修改角色跳转', '', '/pages.modular.system.group/role_edit', 5, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (163, 'to_role_assign', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '角色分配跳转', '', '/pages.modular.system.group/role_assign', 6, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (164, 'role_list', 'pages.modular.system.group', '[0],[system],[pages.modular.system.group],', '角色列表', '', '/pages.modular.system.group/list', 7, 3, 'N', NULL, 'ENABLE', NULL, NULL, NULL, NULL, NULL, NULL);
